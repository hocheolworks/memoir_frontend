  ...
  return (
    ...
    >
      <div className="w-1/2 px-12 pt-8">
        <div className="max-h-[525px] bg-white dark:bg-black">
          <textarea
            ref={textareaRef}
            className="w-full resize-none overflow-hidden break-words bg-white text-5xl font-bold outline-none dark:bg-black"
