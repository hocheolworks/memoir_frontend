...
export const getUnorderedListCommandWithSize = (
  width: number = 12,
  height: number = 12
): commands.ICommand => {
  return {
...
export const unorderedListCommand: commands.ICommand = {
  name: "unordered-list",
  keyCommand: "list",
...
export const getOrderedListCommandWithSize = (
  width: number = 12,
  height: number = 12
): commands.ICommand => {
  return {
...
export const orderedListCommand: commands.ICommand = {
  name: "ordered-list",
  keyCommand: "list",
...
export const getCheckedListCommandWithSize = (
  width: number = 12,
  height: number = 12
): commands.ICommand => {
  return {
...
export const checkedListCommand: commands.ICommand = {
  name: "checked-list",
  keyCommand: "list",
