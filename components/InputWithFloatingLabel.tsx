...
const InputWithFloatingLabel: FC<InputWithFloatingLabelProps> = ({
  ...
  return (
    <div className={"relative" + (className ? ` ${className}` : "")}>
      <input
        id={id}
        className="placeholder:text-black focus:placeholder:text-gray-600 block px-2.5 pb-2.5 pt-4 w-full text-2xl text-gray-900 bg-transparent rounded-lg border-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
        type={type}
