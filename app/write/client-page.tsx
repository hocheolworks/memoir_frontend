...
const WriteClientPage: NextPage = () => {
  ...
  const mode = postId !== undefined ? "update" : "publish";
  const id = mode === "update" ? parseInt(postId as string) : -1;
  ...
  return (
    <>
      <div
        className="absolute bottom-0 left-0 right-0 top-0 z-20 flex h-full overflow-hidden bg-white dark:bg-black"
      ...
      >
        <div className="flex w-full flex-col px-12 pt-8 lg:w-1/2">
          <div className="bg-white dark:bg-black">
            <textarea
              ...
              rows={1}
            />
            <hr className="mb-5 ml-0.5 mt-4 w-72 border-2 border-gray-500" />
            {/* <TagInput
              tagList={tagList}
        ...
        <div
          className="hidden h-full overflow-y-auto rounded-none bg-neutral-50 px-12 pb-24 pt-12 dark:bg-neutral-800 lg:block lg:w-1/2"
...
export default WriteClientPage;
